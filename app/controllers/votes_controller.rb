class VotesController < ApplicationController
  ...
  def create 
    ...
    if already_voted?(@poll )
      render status: :ok, json: { notice: "already voted" }
    else
      ...
      if vote.save
        ...
        render status: :ok, json: { success: "Voted successfuly" }
      else
        render status: :unprocessable_entity, json: { errors: vote.errors.full_message }
      end   
    end
